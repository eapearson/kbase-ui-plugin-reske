    ...
    */
    ...
    function viewModel(params) {
        ...
        function doSearch() {
            ...
            currentSearch.search = searchObjects(runtime, 'genome', searchInput(), withPublicData(), withPrivateData(), pageStart(), pageSize())
                .spread(function (result, filter) {
                    ...
                    var originalObjectSpecs = result.objects.map(function (object) {
                        return {
                            wsid: object.genome.workspace.workspaceId,
                            objid: object.genome.workspace.objectId,
                            ver: 1
                        };
                    });
                    ...
                    var currentObjectSpecs = result.objects.map(function (object) {
                        return {
                            wsid: object.genome.workspace.workspaceId,
                            objid: object.genome.workspace.objectId,
                            ver: object.genome.workspace.objectVersion
                        };
                    });
                    ...
                    return Promise.all([
                        ...
                        Promise.all(result.objects.map(function (object) {
                            return workspace.callFunc('get_workspace_info', [{
                                id: object.genome.workspace.workspaceId
                            }]).spread(function (result) {
    ...
    function template() {
        return div({
            class: 'component-reske-browse-genomes'
        }, [
            div({
                style: {
    ...
    ko.components.register('reske/browse-genomes', component());
});